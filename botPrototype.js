...
bot.on("message", msg => {
  if (msg.guild.id == "284433301945581589" && msg.channel == "294355049998581760" && msg.author.id == "268231075011100672" && msg.embeds && msg.embeds[0].title == "Drone Encounter" && msg.embeds[0].description.startsWith("A drone")) msg.channel.sendMessage("!attack");
